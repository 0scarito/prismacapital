    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16">
        ...
        <section 
          ...
          style={{ backgroundImage: `url(${heroImages.privateEquity})` }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-slate-900/80 to-blue-900/70" />
            ...
            <div className="grid grid-cols-3 gap-8 max-w-4xl mx-auto">
              {metrics.map((m) => (
                <div key={m.label} className="text-center bg-black/20 backdrop-blur-sm rounded-lg p-4">
                  <div className="text-3xl font-bold text-blue-300">{m.value}</div>
