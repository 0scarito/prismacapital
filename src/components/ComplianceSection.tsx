  ...
  return <section className="py-12 bg-deep-navy border-t border-border/20">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="text-center">
          <p className="font-sans text-sm text-warm-white/80 leading-relaxed max-w-4xl mx-auto">
            Prisma Capital is not a financial intermediary. Equity subscriptions are executed by [Partner-Name],
