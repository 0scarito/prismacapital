...
const PrivateEquity = () => {
  ...
  return <div className="min-h-screen bg-background">
        ...
        backgroundPosition: 'center'
      }} className="relative py-16 mb-12 overflow-hidden opacity-100">
          ...
          <div className="section-container relative z-10">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-3xl">
              {metrics.map(m => <div key={m.label} className="backdrop-blur rounded-lg p-4 text-center bg-muted-foreground">
